...
func WithErrorFrameTheme(theme string) ErrorFrameOption {
	return func(e *ErrorFrame) {
		e.designTokens = designTokensForTheme(theme)
	}
}
...
func (e *ErrorFrame) Update(msg tea.Msg) (Component, tea.Cmd) {
	switch msg := msg.(type) {
...
func (e *ErrorFrame) View() string {
	...
	titleColor := ansiBold + borderColor
...
func (e *ErrorFrame) errorColor() string {
	if e.designTokens != nil {
		if c := ansiColorFromHex(e.designTokens.Accent); c != "" {
			return c
		}
	}
	return ansiRed
...
var _ Component = (*ErrorFrame)(nil)

	...
	header := tui.NewHeader(
		tui.WithColumns(
			...
			tui.HeaderColumn{
				...
				Content: []string{"TUI Component Gallery", "Content persists in terminal"},
			},
			tui.HeaderColumn{
				Width:   25,
...
func (m model) View() string {
	if m.quitting {
		return "\n✓ Demo completed. Content remains in your terminal history.\n"
	}
	...
	s += "\n"
	s += "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
	s += "Keys: r (run activity) | s (stop) | q (quit)\n"
	s += "Note: Content persists in terminal - scroll up to see history\n"
